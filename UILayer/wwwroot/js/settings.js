! function(t) {
    ...
    (l || f) && (a = function(t) {
        var n, e, r, o, a = this;
        return f && (e = new RegExp("^" + a.source + "$(?!\\s)", i.call(a))), l && (n = a.lastIndex), r = u.call(a, t), l && r && (a.lastIndex = a.global ? r.index + r[0].length : n), f && r && r.length > 1 && c.call(r[0], e, (function() {
    ...
    t.exports = function(t) {
        return function(n, e) {
            var i, u, c = String(o(n)),
                a = r(e),
                l = c.length;
            return a < 0 || a >= l ? t ? "" : void 0 : (i = c.charCodeAt(a)) < 55296 || i > 56319 || a + 1 === l || (u = c.charCodeAt(a + 1)) < 56320 || u > 57343 ? t ? c.charAt(a) : i : t ? c.slice(a, a + 2) : u - 56320 + (i - 55296 << 10) + 65536
        }
    }
}, function(t, n, e) {
    var r = e(15),
    ...
    var r = e(3),
        ...
        a = function(t, n, e) {
            ...
            for (l in d && (e = n), e) s = ((f = !v && y && void 0 !== y[l]) ? y : e)[l], p = g && f ? c(s, r) : x && "function" == typeof s ? c(Function.call, s) : s, y && u(y, l, s, t & a.U), m[l] != s && i(m, l, p), x && b[l] != s && (b[l] = s)
        };
    ...
    n.f = e(11) ? Object.defineProperty : function(t, n, e) {
    ...
    e(18)("split", 2, (function(t, n, e, f) {
        var h;
        return h = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[v] || 2 != "ab".split(/(?:ab)*/)[v] || 4 != ".".split(/(.?)(.?)/)[v] || ".".split(/()()/)[v] > 1 || "".split(/.?/)[v] ? function(t, n) {
            var o = String(this);
            if (void 0 === t && 0 === n) return [];
            if (!r(t)) return e.call(o, t, n);
            for (var i, u, c, a = [], f = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), s = 0, d = void 0 === n ? 4294967295 : n >>> 0, h = new RegExp(t.source, f + "g");
                (i = l.call(h, o)) && !((u = h.lastIndex) > s && (a.push(o.slice(s, i.index)), i[v] > 1 && i.index < o[v] && p.apply(a, i.slice(1)), c = i[0][v], s = u, a[v] >= d));) h.lastIndex === i.index && h.lastIndex++;
            ...
            for (var b = 0, S = 0, w = []; S < p.length;) {
                ...
                if (null === E || (_ = s(c(y.lastIndex + (d ? 0 : S)), p.length)) === b) S = u(p, S, x);
                    ...
                    for (var j = 1; j <= E.length - 1; j++)
                        if (w.push(E[j]), w.length === m) return w;
                    S = b = _
                }
            }
    ...
    e.r(n);
    e(131), e(38);
    var r, o, i = document.createElement("link");
    i.href = "css/" + (r = function(t) {
        ...
        var n = void 0;
        return location.search.substr(1).split("&").some((function(e) {
            return e.split("=")[0] == t && (n = e.split("=")[1])
        })), n
    }("theme")) ? (function(t, n, e) {
        var r = "";
        if (e) {
            var o = new Date;
    ...
    }("theme", o, 7), o) : r || "modern") + ".css"), i.type = "text/css", i.rel = "stylesheet", document.getElementsByTagName("head")[0].appendChild(i)
}, function(t, n, e) {
    "use strict";
    var r = e(2),
        o = e(132),
